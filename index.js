...
bitcore.versionGuard = function (version) {
  if (version !== undefined) {
    var message =
      'More than one instance of gobytecore-lib found. ' +
      'Please make sure that you are not mixing instances of classes of the different versions of gobytecore.';
    console.warn(message);
  }
};
bitcore.versionGuard(global._gobytecore);
global._gobytecore = bitcore.version;

# Contributing to gobytecore-lib

We're working hard to make _gobytecore-lib_ the most powerful JavaScript library for working with GoByte. Our goal is to have _gobytecore-lib_ be a library that can be used by anyone interested in GoByte, and to level expertise differences with great design and documentation.

## Community

If there are any questions, etc., please feel to ask in one of the community channels:

- https://www.gobyte.network/forum (Support Forum)
...
These are some global design goals in gobytecore-lib that any change must adhere.
...
When possible, gobytecore-lib objects should have standard methods on an instance prototype:
...
`JSON.stringify` and `JSON.parse` are expected to be handled outside of the scope of gobytecore-lib methods. For example, calling `JSON.stringify` on an gobytecore-lib object will behave as expected and call `transaction.toJSON()` and then stringify it:
...
#### T3 - Require 'gobytecore' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the gobytecore object.

DO:

```javascript
var gobytecore = require('../');
var PublicKey = gobytecore.PublicKey;
```
...
```sh
git remote add gobytecoin git@github.com:gobytecoin/gobytecore-lib.git
git pull --rebase gobytecoin master
```
...
Finally go to [github.com/gobytecoin/gobytecore-lib](https://github.com/gobytecoin/gobytecore-lib) in your web browser and issue a new pull request.

Main contributors will review your code and possibly ask for changes before your code is pulled in to the main repository. We'll check that all tests pass, review the coding style, and check for general code correctness. If everything is OK, we'll merge your pull request and your code will be part of gobytecore-lib.

If you have any questions feel free to post them to
[github.com/gobytecoin/gobytecore-lib/issues](https://github.com/gobytecoin/gobytecore-lib/issues).

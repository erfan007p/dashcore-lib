 ...
 * ```javascript
 *
 * var uri = new URI('gobyte:GQ9w7ojnrEL286oZsxAQ9gfjQfGFmMoh1m?amount=1.2');
 ...
 * ```javascript
 *
 * var valid = URI.isValid('gobyte:GQ9w7ojnrEL286oZsxAQ9gfjQfGFmMoh1m');
 * // true
 * ```
 *
...
URI.parse = function (uri) {
  ...
  if (info.protocol !== 'gobyte:') {
    throw new TypeError('Invalid gobyte URI');
  }
...
URI.prototype._fromObject = function (obj) {
  ...
  if (!Address.isValid(obj.address)) {
    throw new TypeError('Invalid gobyte address');
  }

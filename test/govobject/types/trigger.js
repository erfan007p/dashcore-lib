...
describe('Trigger', function () {
  ...
  it('should return error if mismatched addresses / amounts / hashes', function () {
    ...
    trigger.network = 'testnet';
    trigger.event_block_height = 110976;
    trigger.payment_addresses = 'nBPubv7rUxwCrWjry5PKvxV6iEnWF27AAP';
    trigger.payment_amounts = '10.00000000|12.00000000';
    trigger.proposal_hashes =
      '20596d41ac6c9f6bfb9a02e43cd77ef1ed1a0e9d70857e5110e6aa9de0ce12fb|6767927761890eefaa6f80542aad6981fb966eed7c1deaf616464a739d81b8d7';
    trigger.type = 2;
  ...
  it('should parse a serialised datahex trigger', function () {
    var datahex =
      '';

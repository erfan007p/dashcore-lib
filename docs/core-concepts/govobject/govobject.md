...
A Governance Object (or "govObject") is a generic structure introduced in GoByte Core v12.1 to allow for the creation of Budget Proposals, Triggers, and Watch Dogs. Class inheritance has been utilized to extend this generic object into a "Proposal" which is outlined throughout the remainder of this document.
...
Return a hex string that can be used in gobyted CLI
...
var jsonProposal = {
  ...
  payment_amount: 10,
  type: 1,
  url: 'http://www.gobyte.network/proposal/first_proposal',
};
...
```javascript
proposal.url = 'http://gobyte.network/badUrl';
var shallowCopyProposal = proposal.shallowCopy();
proposal.url = 'http://gobyte.network/fixedUrl';
